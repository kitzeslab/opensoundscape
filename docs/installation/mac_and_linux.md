...
OpenSoundscape can be installed on Mac and Linux machines with Python >=3.9 using the pip command `pip install opensoundscape==0.10.2`. We recommend installing OpenSoundscape in a virtual environment to prevent dependency conflicts.
...
* Install opensoundscape using pip: `pip install opensoundscape==0.10.2`
...
* Install OpenSoundscape in the environment: `pip install opensoundscape==0.10.2`
